...
source /opt/ros/jazzy/setup.bash && source /home/forlinx/robot_cleaning/install/setup.bash && ros2 launch rtk_nav run.launch.py 2>&1 | /usr/bin/python3 /home/forlinx/robot_cleaning/rotate_motor_start_log.py
